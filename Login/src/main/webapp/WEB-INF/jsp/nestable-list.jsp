...
<title>可拖拽列表 - UI元素 - 统一开发平台 - UI库</title>
			...
			<ul class="nav nav-list">
				...
				<li class="active open"><a href="#" class="dropdown-toggle">
					...
					<ul class="submenu">
						...
						<li class="active"><a href="nestable-list.html"> <i
		...
		<div class="main-content">
			...
			<div class="breadcrumbs" id="breadcrumbs">
				<ul class="breadcrumb">
					...
					<li><a href="nestable-list.html">可拖拽列表</a></li>
				</ul>
				<!-- /.breadcrumb -->
											...
											<li class="dd-item" data-id="2">
												...
												<ol class="dd-list">
													<li class="dd-item" data-id="3">
														<div class="dd-handle">
															第二层列表 <a data-rel="tooltip" data-placement="left"
																title="这里可以放日期时间的提示信息" href="#"
													...
													<li class="dd-item" data-id="4">
														<div class="dd-handle">
															<span class="orange">第二层列表</span> <span
																class="lighter grey"> &nbsp;这里可以放置一些描述内容 </span>
														</div>
													</li>
										...
										<ol class="dd-list">
											<li class="dd-item dd2-item" data-id="13">
												<div class="dd-handle dd2-handle">
													<i
														class="normal-icon ace-icon fa fa-comments blue bigger-130"></i>
											...
											<li class="dd-item dd2-item" data-id="14">
												<div class="dd-handle dd2-handle">
													<i
														class="normal-icon ace-icon fa fa-clock-o pink bigger-130"></i>
											...
											<li class="dd-item dd2-item" data-id="15">
												<div class="dd-handle dd2-handle">
													<i
														class="normal-icon ace-icon fa fa-signal orange bigger-130"></i>
												...
												<ol class="dd-list">
													...
													<li class="dd-item dd2-item dd-colored" data-id="17">
														<div class="dd-handle dd2-handle btn-info">
															<i
																class="normal-icon ace-icon fa fa-pencil-square-o bigger-130"></i>
													...
													<li class="dd-item dd2-item" data-id="18">
														<div class="dd-handle dd2-handle">
															<i
																class="normal-icon ace-icon fa fa-eye green bigger-130"></i>
