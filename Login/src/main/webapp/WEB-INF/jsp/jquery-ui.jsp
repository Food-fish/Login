...
<title>JqueryUI - UI元素 - 统一开发平台 - UI库</title>
		...
		<div class="main-content">
			...
			<div class="breadcrumbs" id="breadcrumbs">
				<ul class="breadcrumb">
					...
					<li><a href="elements.html">JqueryUI</a></li>
				</ul>
				<!-- /.breadcrumb -->
					...
					<div class="row">
						<div class="col-xs-12">
							...
							<div class="row">
								<div class="col-sm-6">
									<h3 class="header blue lighter smaller">
										<i class="ace-icon fa fa-calendar-o smaller-90"></i> 日历插件
									</h3>
								...
								<div class="col-sm-6">
									<h3 class="header blue lighter smaller">
										<i class="ace-icon fa fa-list-alt smaller-90"></i> 弹出层
									</h3>
							...
							<div class="row">
								<div class="col-sm-6">
									<h3 class="header blue lighter smaller">
										<i class="ace-icon fa fa-terminal smaller-90"></i> 自动完成
									</h3>
									...
									<div class="row">
										<div class="col-xs-12">
											<h3 class="header blue lighter smaller">
												<i class="ace-icon fa fa-info smaller-90"></i> 文字提示
											</h3>
											...
											<div class="bigger-110">
												<p>
													<a class="grey" id="show-option" href="#"
														...
														class="ace-icon fa fa-hand-o-right"></i> 下拉提示样式
													</a>
												</p>
												...
												<p>
													<a class="blue" id="hide-option" href="#"
														...
														class="ace-icon fa fa-hand-o-right"></i> 裂开提示样式
													</a>
												</p>
												...
												<p>
													<a class="pink" id="open-event" href="#"
														...
														class="ace-icon fa fa-hand-o-right"></i> 上拉提示样式
													</a>
												</p>
											</div>
										</div>
								...
								<div class="col-sm-6">
									<h3 class="header blue lighter smaller">
										<i class="ace-icon fa fa-bars smaller-90"></i> 菜单样式
									</h3>
