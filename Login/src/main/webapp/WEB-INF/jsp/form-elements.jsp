...
<![endif]-->
	...
	<script src="${path}/js/fuelux/fuelux.spinner.min.js"></script>
	...
	<script src="${path}/js/jquery.autosize.min.js"></script>
	<script src="${path}/js/jquery.inputlimiter.1.3.1.min.js"></script>
	<script src="${path}/js/jquery.maskedinput.min.js"></script>
	<script src="${path}/js/bootstrap-tag.min.js"></script>
	<script src="${path}/js/typeahead.jquery.min.js"></script>
	...
	<link rel="stylesheet" href="${path}/css/ace.onpage-help.css" />
	<link rel="stylesheet" href="../docs/${path}/js/themes/sunburst.css" />

	<script type="text/javascript"> ace.vars['base'] = '..'; </script>
	<script src="${path}/js/ace/elements.onpage-help.js"></script>
	<script src="${path}/js/ace/ace.onpage-help.js"></script>
	<script src="../docs/${path}/js/rainbow.js"></script>
	<script src="../docs/${path}/js/language/generic.js"></script>
	<script src="../docs/${path}/js/language/html.js"></script>
	<script src="../docs/${path}/js/language/css.js"></script>
	<script src="../docs/${path}/js/language/javascript.js"></script>
</body>
</html>