...
<title>按钮、图标 - UI元素 - 统一开发平台 - UI库</title>
		...
		<div class="main-content">
			...
			<div class="breadcrumbs" id="breadcrumbs">
				<ul class="breadcrumb">
					...
					<li><a href="elements.html">按钮 & 图标</a></li>
				</ul>
				<!-- /.breadcrumb -->
						...
						<div class="col-xs-12">
							...
							<div class="row">
								<div class="col-sm-12" id="default-buttons">
									<h3 class="row header smaller lighter grey">
										<span class="col-sm-6">常用按钮</span>
										<!-- /.col -->

										<span class="col-sm-6"> <label
											class="pull-right inline"> <small
												class="muted smaller-90">按钮是否有边框：</small> <input
									...
									<p>
										...
										<button class="btn btn-white btn-pink btn-round">
											<i class="ace-icon fa fa-pencil red2"></i> 取消
										</button>
									</p>
									...
									<p>
										...
										<button class="btn btn-success">
											<i class="ace-icon fa fa-check"></i> 绿色背景
										</button>

										<button class="btn btn-warning">
											<i class="ace-icon fa fa-fire bigger-110"></i> <span
												class="bigger-110 no-text-shadow">黄色背景</span>
										</button>

										<button class="btn btn-danger">

											红色背景 <i class="ace-icon fa fa-arrow-right icon-on-right"></i>
										</button>
									</p>
								...
								<div class="col-sm-12">
									...
									<div class="btn-group btn-corner">
										...
										<button id="loading-btn" type="button" class="btn btn-success"
											data-loading-text="正在支付中，请稍后...">Ajax操作使用的按钮</button>
									</div>
									...
									<div>
										...
										<div data-toggle="buttons"
											...
											<label class="btn btn-sm btn-white btn-info"> <input
												type="checkbox" value="1" /> 颜色
											</label> <label class="btn btn-sm btn-white btn-info"> <input
												type="checkbox" value="2" /> 价钱
											</label> <label class="btn btn-sm btn-white btn-info"> <input
												type="checkbox" value="3" /> 产地
											</label>
										</div>
									...
									<div class="btn-toolbar">
										<div class="btn-group">
											<button data-toggle="dropdown" class="btn dropdown-toggle">
												更多... <span class="ace-icon fa fa-caret-down icon-on-right"></span>
											</button>
										...
										<div class="btn-group">
											<button data-toggle="dropdown"
												...
												更多... <i class="ace-icon fa fa-angle-down icon-on-right"></i>
											</button>
							...
							<div class="row">
								<div class="col-sm-12">
									...
									<p>
										<span class="label">默认样式</span> <span
											class="label label-success arrowed">提交成功</span> <span
											class="label label-sm label-warning"> <i
											class="ace-icon fa fa-exclamation-triangle bigger-120"></i>
											警告信息
										</span> <span class="label label-xlg label-danger arrowed-in">危险警告信息</span>
										<span
											class="label label-lg label-info arrowed-in-right arrowed">普通信息</span>
							...
							<div class="row">
								<div class="col-xs-12">
									<h3 class="header smaller lighter grey">
										部分基于FontAwesome字体样式的图标 <small> <a
											href="http://fontawesome.io/icons/" target="_blank">
												(点击查看完整的FontAwesome字体样式的图标 <i
								...
								<div class="col-xs-6 col-sm-3">
									<ul class="list-unstyled">
										...
										<li><i class="ace-icon fa fa-bar-chart-o"></i>
											fa-bar-chart-o</li>
										...
										<li><i class="ace-icon fa fa-bookmark-o"></i>
											fa-bookmark-o</li>

										<li><i class="ace-icon fa fa-briefcase"></i> fa-briefcase
										</li>
										...
										<li><i class="ace-icon fa fa-camera-retro"></i>
											fa-camera-retro</li>

										<li><i class="ace-icon fa fa-certificate"></i>
											fa-certificate</li>
									</ul>
								</div>
								...
								<div class="col-xs-6 col-sm-3">
									<ul class="list-unstyled">
										...
										<li><i class="ace-icon fa fa-cloud-upload"></i>
											fa-cloud-upload</li>
										...
										<li><i class="ace-icon fa fa-comment-o"></i> fa-comment-o
										</li>

										<li><i class="ace-icon fa fa-comments"></i> fa-comments</li>

										<li><i class="ace-icon fa fa-comments-o"></i>
											fa-comments-o</li>

										<li><i class="ace-icon fa fa-credit-card"></i>
											fa-credit-card</li>
								...
								<div class="col-xs-6 col-sm-3">
									<ul class="list-unstyled">
										...
										<li><i class="ace-icon fa fa-envelope-o"></i>
											fa-envelope-o</li>
										...
										<li><i class="ace-icon fa fa-eye-slash"></i> fa-eye-slash
										</li>

										<li><i class="ace-icon fa fa-eye"></i> fa-eye</li>

										<li><i class="ace-icon fa fa-video-camera"></i>
											fa-video-camera</li>

										<li><i class="ace-icon fa fa-fighter-jet"></i>
											fa-fighter-jet</li>
										...
										<li><i class="ace-icon fa fa-folder-open"></i>
											fa-folder-open</li>
								...
								<div class="col-xs-6 col-sm-3">
									<ul class="list-unstyled">
										...
										<li><i class="ace-icon fa fa-headphones"></i>
											fa-headphones</li>
										...
										<li><i class="ace-icon fa fa-info-circle"></i>
											fa-info-circle</li>
										...
										<li><i class="ace-icon fa fa-lightbulb-o"></i>
											fa-lightbulb-o</li>
