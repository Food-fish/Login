			...
			<ul class="nav nav-list">
				...
				<li class="active open"><a href="#" class="dropdown-toggle">
					...
					<ul class="submenu">
						...
						<li class="active"><a href="invoice.html"> <i
							...
							<div class="widget-box transparent invoice-box">
								<div class="widget-header widget-header-large">
									<h3 class="grey lighter pull-left position-relative">
										<i class="icon-leaf green"></i> 机票订单详情
									</h3>

									<div class="widget-toolbar no-border invoice-info">
										<span class="invoice-info-label">订单号:</span> <span class="red">#121212</span>

										<br /> <span class="invoice-info-label">订单日期:</span> <span
											class="blue">03/03/2013</span>
									</div>
									...
									<div class="widget-main padding-24">
										<div class="row">
											<div class="col-sm-6">
												...
												<div class="row">
													<ul class="list-unstyled spaced">
														...
														<li><i class="icon-caret-right blue"></i> 邮编：513000</li>

														<li><i class="icon-caret-right blue"></i> 省市：广东省，广州市
														</li>

														<li><i class="icon-caret-right blue"></i> 起落机场:广州 -
															纽约 <b class="red">111-111-111</b></li>

														<li><i class="icon-caret-right blue"></i> 订单状态：已支付</li>
													</ul>
												</div>
											</div>
											<!-- /span -->
											...
											<div class="col-sm-6">
												...
												<div>
													<ul class="list-unstyled  spaced">
														<li><i class="icon-caret-right green"></i> 姓名：张三</li>

														<li><i class="icon-caret-right green"></i> 英文名：Zhang
															San</li>
											...
											<table class="table table-striped table-bordered">
												...
												<tbody>
													...
													<tr>
														...
														<td>座位选择服务</td>
														<td class="hidden-xs">用户自助选择作为</td>
														<td class="hidden-480">---</td>
														<td>---</td>
													</tr>
												</tbody>
