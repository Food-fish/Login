			...
			<ul class="nav nav-list">
				...
				<li class="active open"><a href="#" class="dropdown-toggle">
					...
					<ul class="submenu">
						...
						<li class="active"><a href="jqgrid.html"> <i
		...
		<div class="main-content">
			<div class="breadcrumbs" id="breadcrumbs">
				<ul class="breadcrumb">
					...
					<li><a href="elements.html">jqGrid插件表格</a></li>
				</ul>
				<!-- /.breadcrumb -->
					...
					<div class="row">
						<div class="col-xs-12">
							...
							<div class="well well-sm">
								<button type="button" class="close line-height-0"
									data-dismiss="alert">
									<i class="ace-icon fa fa-times smaller-75"></i>
								</button>
								表格是基于jqgrid的通用表格 <i class="fa fa-external-link bigger-110"></i>
							</div>
