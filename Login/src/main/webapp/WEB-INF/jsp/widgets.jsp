	...
	<div class="main-container" id="main-container">
		...
		<div id="sidebar" class="sidebar responsive">
			<ul class="nav nav-list">
				...
				<li class="active open"><a href="widgets.html"> <i
		...
		<div class="main-content">
			...
			<div class="breadcrumbs" id="breadcrumbs">
				<ul class="breadcrumb">
					...
					<li><a href="javascript:void(0)">插件页</a></li>
				</ul>
				<!-- /.breadcrumb -->
										...
										<div class="col-xs-12 col-sm-6 widget-container-span">
											<div class="widget-box">
												<div class="widget-header">
													<h5 style="display: inline-block;">默认带插件小图标功能DIV</h5>
												...
												<div class="widget-body">
													<div class="widget-main">
														<p class="alert alert-info">
															根据广州白云国际机场发布的航行通告，为做好第三跑道启用、完成机场跑道和滑行道编号的一夜切换工作，广州白云国际机场将于2月4日23:30停止接收航班起降，2月5日0:00关闭机场，8:00重新开航。原计划在此期间在白云国际机场起降的南航航班将受到影响。
														</p>
														<p class="alert alert-success">
															2015年春运从2月4日开始，到3月15日结束。今年春节时间较晚，从南航目前旅客购票情况看，节前客流最高峰较往年有所分散，大多集中在除夕前10天左右。回程客流最高峰仍然集中在初五到初七，预计正月十五前后也将迎来一轮返程高峰。为充分满足广大旅客出行需求，南航计划在春运40天期间，申请增加航班8000余班次，共将执行国内、国际航班约85000余班，航班量总同比增长27%，为春运旅客出行提供丰富选择。
														</p>
													</div>
												</div>
											</div>
														...
														<table
															...
															<tbody>
																<tr>
																	...
																	<td><a href="#">alex@csair.com</a></td>

																	<td class="hidden-480"><span
																		class="label label-warning">出票中</span></td>
																</tr>

																<tr>
																	<td class="">Fred</td>

																	<td><a href="#">fred@csair.com</a></td>

																	<td class="hidden-480"><span
																		class="label label-success arrowed-in arrowed-in-right">已出票</span>
																	</td>
																</tr>
																...
																<tr>
																	...
																	<td><a href="#">john@csair.com</a></td>

																	<td class="hidden-480"><span
																		class="label label-inverse arrowed">冻结状态</span></td>
																</tr>

																<tr>
																	<td class="">James</td>

																	<td><a href="#">james@csair.com</a></td>

																	<td class="hidden-480"><span
																		class="label label-info arrowed-in arrowed-in-right">正在出票中</span>
																	</td>
																</tr>
															</tbody>
														</table>
