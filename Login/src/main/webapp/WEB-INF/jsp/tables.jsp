		...
		<div class="main-content">
			<div class="breadcrumbs" id="breadcrumbs">
				<ul class="breadcrumb">
					...
					<li><a href="elements.html">简单通用表格</a></li>
				</ul>
				<!-- /.breadcrumb -->
					...
					<div class="row">
						<div class="col-xs-12">
										...
										<tbody>
											<tr>
												...
												<td class="hidden-480"><span
													class="label label-sm label-warning">5千克</span></td>
												<td>
											...
											<tr>
												...
												<td class="hidden-480"><span
													class="label label-sm label-success">5千克</span></td>
												<td>
													<div class="hidden-sm hidden-xs btn-group">
														<button class="btn btn-xs btn-success" title="">
															<i class="ace-icon fa fa-search-plus bigger-120"></i>
											...
											<tr>
												...
												<td class="hidden-480"><span
													class="label label-sm label-inverse arrowed-in">5千克</span>
												</td>
												<td>
													<div class="hidden-sm hidden-xs btn-group">
														<button class="btn btn-xs btn-success" title="">
											...
											<tr>
												...
												<td class="hidden-480"><span
													class="label label-sm label-warning arrowed-right">5千克</span>
												</td>
												<td>
													<div class="hidden-sm hidden-xs btn-group">
														<button class="btn btn-xs btn-success" title="">
							...
							<h4 class="pink">
								...
								<a href="#modal-table" role="button" class="blue"
									data-toggle="modal">点击弹出层表格</a>
							</h4>
