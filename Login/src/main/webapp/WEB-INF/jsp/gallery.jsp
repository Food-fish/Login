	...
	<div class="main-container" id="main-container">
		...
		<div id="sidebar" class="sidebar responsive">
			<ul class="nav nav-list">
				...
				<li class="active open"><a href="gallery.html"> <i
						...
						<div class="col-xs-12">
							...
							<div class="row-fluid">
								<ul class="ace-thumbnails">
									<li><a href="${path}/images/gallery/image-1.jpg"
										title="Photo Title" data-rel="colorbox"> <img
											alt="150x150" src="${path}/images/gallery/thumb-1.jpg" />
											<div class="tags">
												<span class="label-holder"> <span
													class="label label-info">机上早餐</span>
												</span> <span class="label-holder"> <span
													class="label label-danger">水果</span>
												</span> <span class="label-holder"> <span
													class="label label-success">面包</span>
												</span> <span class="label-holder"> <span
													class="label label-warning arrowed-in">鸡肉</span>
												</span>
											</div>
									</a>
									...
									<li><a href="${path}/images/gallery/image-2.jpg"
										data-rel="colorbox"> <img alt="150x150"
											src="${path}/images/gallery/thumb-2.jpg" />
											<div class="text">
												<div class="inner">带遮罩层的图片例子</div>
											</div>
									</a></li>

									<li><a href="${path}/images/gallery/image-3.jpg"
										data-rel="colorbox"> <img alt="150x150"
											src="${path}/images/gallery/thumb-3.jpg" />
											<div class="text">
									...
									<li><a href="${path}/images/gallery/image-4.jpg"
										data-rel="colorbox"> <img alt="150x150"
											src="${path}/images/gallery/thumb-4.jpg" />
											<div class="tags">
												<span class="label-holder"> <span
													class="label label-info arrowed">我是提示</span>
												</span> <span class="label-holder"> <span
													class="label label-danger">我也是提示</span>
												</span>
											</div>
									</a>
									...
									<li>
										<div>
											...
											<div class="text">
												<div class="inner">
													<span>带功能图标的图片例子</span> <br /> <a
														href="${path}/images/gallery/image-5.jpg"
									...
									<li><a href="${path}/images/gallery/image-6.jpg"
										data-rel="colorbox"> <img alt="150x150"
											src="${path}/images/gallery/thumb-6.jpg" />
									</a>
									...
									<li><a href="${path}/images/gallery/image-1.jpg"
										data-rel="colorbox"> <img alt="150x150"
											src="${path}/images/gallery/thumb-1.jpg" />
									</a>
