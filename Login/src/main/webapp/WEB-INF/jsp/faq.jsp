		...
		<div id="sidebar" class="sidebar responsive">
			<ul class="nav nav-list">
				...
				<li class="active open"><a href="#" class="dropdown-toggle">
					...
					<ul class="submenu">
						<li class="active"><a href="faq.html"> <i
							...
							<div class="tabbable">
								...
								<ul class="nav nav-tabs padding-18 tab-size-bigger" id="myTab">
									...
									<li><a data-toggle="tab" href="#faq-tab-2"> <i
											class="green ace-icon fa fa-user bigger-120"></i> 账户帮助
									</a></li>
									...
									<li class="dropdown"><a data-toggle="dropdown"
										class="dropdown-toggle" href="#"> <i
											class="purple ace-icon fa fa-magic bigger-120"></i> 更多帮助 <i
											class="ace-icon fa fa-caret-down"></i>
									</a>

										<ul class="dropdown-menu dropdown-lighter dropdown-125">
											<li><a data-toggle="tab" href="#faq-tab-4"> 交通帮助 </a></li>

											<li><a data-toggle="tab" href="#faq-tab-4"> 出行向导 </a></li>
										</ul></li>
									<!-- /.dropdown -->
								</ul>
								...
								<div class="tab-content no-border padding-24">
									<div id="faq-tab-1" class="tab-pane fade in active">
										<h4 class="blue">
											<i class="ace-icon fa fa-check bigger-110"></i> 常用帮助
										</h4>
										...
										<div id="faq-list-1"
											...
											<div class="panel panel-default">
												<div class="panel-heading">
													<a href="#faq-1-1" data-parent="#faq-list-1"
														...
														class="ace-icon fa fa-user bigger-130"></i> &nbsp; 旅客如何定座
													</a>
												</div>
											...
											<div class="panel panel-default">
												<div class="panel-heading">
													<a href="#faq-1-2" data-parent="#faq-list-1"
														...
														data-icon-hide="ace-icon fa fa-chevron-down"
														data-icon-show="ace-icon fa fa-chevron-left"></i> <i
														class="ace-icon fa fa-sort-amount-desc"></i> &nbsp;
														儿童票、婴儿票
													</a>
												</div>
															...
															<div class="panel panel-default">
																<div class="panel-heading">
																	<a href="#faq-list-1-sub-1"
																		...
																		class="ace-icon fa fa-plus smaller-80 middle"
																		data-icon-hide="ace-icon fa fa-minus"
																		data-icon-show="ace-icon fa fa-plus"></i>&nbsp; 旅客如何购座
																	</a>
																</div>
															...
															<div class="panel panel-default">
																<div class="panel-heading">
																	<a href="#faq-list-1-sub-2"
																		...
																		class="ace-icon fa fa-plus smaller-80 middle"
																		data-icon-hide="ace-icon fa fa-minus"
																		data-icon-show="ace-icon fa fa-plus"></i>&nbsp; 特殊旅客购票
																	</a>
																</div>
															...
															<div class="panel panel-default">
																<div class="panel-heading">
																	<a href="#faq-list-1-sub-3"
																		...
																		class="ace-icon fa fa-plus smaller-80 middle"
																		data-icon-hide="ace-icon fa fa-minus"
																		data-icon-show="ace-icon fa fa-plus"></i>&nbsp; 机上座位预订
																	</a>
																</div>
											...
											<div class="panel panel-default">
												...
												<div class="panel-collapse collapse" id="faq-1-5">
													<div class="panel-body">
														A/F/J/舱客票及按A/F/J舱票价计算的儿童客票的退票：航班规定离站时间之前
														2小时（含）前收取客票票面价5％的退票费；航班规定离站时间之前2小时（不含）后收取客票票面价10％的退票费；按A/F/J舱票价计算的婴儿客票、革命伤残军人和因公致残人民警察优惠票的退票：免收退票费。
													</div>
												</div>
											</div>
										</div>
									...
									<div id="faq-tab-2" class="tab-pane fade">
										<h4 class="blue">
											<i class="green ace-icon fa fa-user bigger-110"></i> 账户帮助
										</h4>
										...
										<div id="faq-list-2"
											...
											<div class="panel panel-default">
												...
												<div class="panel-collapse collapse" id="faq-2-2">
													<div class="panel-body">
														用户应遵守《中华人民共和国民用航空法》及中国有关法律、法规和本网站有关规定。</div>
												</div>
											</div>
											...
											<div class="panel panel-default">
												...
												<div class="panel-collapse collapse" id="faq-2-3">
													<div class="panel-body">用户有权依本网站规定获得网站提供的各种服务。</div>
												</div>
											</div>
											...
											<div class="panel panel-default">
												...
												<div class="panel-collapse collapse" id="faq-2-4">
													<div class="panel-body">本网站有权在预先通知或不予通知的情况下终止任何免费服务。

														7、本网站因正常的系统维护、系统升级，或者因网络拥塞而导致网站不能访问，本网站不承担任何责任。

														8、本协议及因使用本网站而产生的与本网站之间纠纷，将依据中华人民共和国的有关法律解决。</div>
												</div>
											</div>
										</div>
									</div>
										...
										<div id="faq-list-3"
											...
											<div class="panel panel-default">
												...
												<div class="panel-collapse collapse" id="faq-3-3">
													<div class="panel-body">中文、英文</div>
												</div>
											</div>
											...
											<div class="panel panel-default">
												...
												<div class="panel-collapse collapse" id="faq-3-4">
													<div class="panel-body">
														您通过任何渠道购买的中国南方航空股份有限公司的电子客票均可以办理。</div>
												</div>
											</div>
										</div>
									</div>
									...
									<div id="faq-tab-4" class="tab-pane fade">
										<h4 class="blue">
											<i class="purple ace-icon fa fa-magic bigger-110"></i> 交通帮助
										</h4>
										...
										<div id="faq-list-4"
											...
											<div class="panel panel-default">
												...
												<div class="panel-collapse collapse" id="faq-4-1">
													<div class="panel-body">
														您所在登机口对应的航班的时间，始发、到达城市，以及每个航班的状态。</div>
												</div>
											</div>
											...
											<div class="panel panel-default">
												...
												<div class="panel-collapse collapse" id="faq-4-3">
													<div class="panel-body">航班号码边显示的“e”表示该航班能使用电子客票。</div>
												</div>
											</div>
