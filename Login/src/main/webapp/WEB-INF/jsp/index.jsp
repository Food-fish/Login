				...
				<ul class="nav ace-nav">
								...
								<ul class="dropdown-menu dropdown-navbar">
									<li><a href="#"> <img src="${path}/avatars/avatar.png"
											...
											class="msg-body"> <span class="msg-title"> <span
													...
													class="ace-icon fa fa-clock-o"></i> <!-- <span>2014-12-15 18:00:00</span> -->
					...
					<li class="light-blue"><a data-toggle="dropdown" href="#"
						...
						<ul
							...
							<li><a href="${path}/Page/UserPage"> <i
		...
		<div id="sidebar" class="sidebar responsive">
			...
			<ul class="nav nav-list">
				...
				<li class=""><a href="#" class="dropdown-toggle"> <i
						class="menu-icon fa fa-desktop"></i> <span class="menu-text">UI
							& 元素</span> <b class="arrow fa fa-angle-down"></b>
				</a> <b class="arrow"></b>
					...
					<div class="row">
						<div class="col-xs-12">
							...
							<div class="alert alert-block alert-info">
								...
								<i class="ace-icon fa fa-check green"></i> <strong class="green">最新公告：</strong>
